...
def process_csv_files(input_file, output_file, full_counts_file, chunk_size=1000000):
    ...
    with pd.read_csv(input_file, chunksize=chunk_size, low_memory=False) as reader:
        for i, chunk in enumerate(reader):
            ...
            valid_chunk = chunk[chunk['organism'].str.contains("metagenome", case=False, na=False) & chunk['collection_date_sam'].notna() & chunk['geo_loc_name_country_continent_calc'].notna()]
...
if __name__ == "__main__":
    ...
    output_file = "./data/organism_counts_top15_meta_with_coldate_and_loc.csv"
