...
input_file = "../data/SRA_metadata_before20231211_date_and_continent_metagenomes_assaytype.csv"
output_file = "../data/SRA_metadata_before20231211_date_and_continent_metagenomes_assaytype_metacategory.csv"
