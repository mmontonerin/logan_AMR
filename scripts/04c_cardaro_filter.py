...
def process_csv_files(input_file, output_file, chunk_size=1000000):
    ...
    with pd.read_csv(input_file, chunksize=chunk_size, low_memory=False) as reader:
        for i, chunk in enumerate(reader):
            ...
            filtered_chunk = chunk[
                ...
                chunk['organism'].str.contains("metagenome", case=False) &
                chunk['assay_type'].notna() &
...
if __name__ == "__main__":
    ...
    input_file = "../data/card_metadata_aro_geolocation.csv"
    output_file = "../data/full_card_metadata_aro_allfilters.csv"
    
    # chunk size based on number of rows to be read at a time in the CSV file
    # Adapt to available memory
    process_csv_files(input_file, output_file, chunk_size=3000000)