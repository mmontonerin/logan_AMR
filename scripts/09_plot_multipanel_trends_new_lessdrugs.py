...
plt.savefig("./data/multipanel_prevalence_trends_5years_spline_lessdrugs.png", dpi=1200)
plt.savefig("./data/multipanel_prevalence_trends_5years_spline_lessdrugs.svg")
plt.close(fig)
...
legend_fig.savefig("./data/metagenome_category_legend_2.png", dpi=300, bbox_inches='tight')
legend_fig.savefig("./data/metagenome_category_legend_2.svg", bbox_inches='tight')
